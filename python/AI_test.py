...
while True:
    ...
    if  you_speak == "":
        robot_brain = " I don't thing it, can you speak again or you can written to here "  # đang cần fix vừa nói vừa viết đc nhưng chưa đc
